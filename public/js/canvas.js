...
const drawCircle = (e) => {
    ctx.beginPath(); // creating new path to draw circles
    // getting radius for circle according to the moust pointer
...
const drawTriangle = (e) => {
    ...
    ctx.closePath(); // clsoing path of a triangle so the third line draw automatically
...
sizeSlider.addEventListener("change", () => brushWidth = sizeSlider.value); // pass slider value as brushSize
